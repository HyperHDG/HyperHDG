...
template <unsigned int hyEdge_dim,
          ...
          typename TPCC::boundaries bndT,
          typename index_t>
index_t n_elements(const tpcc_t<hyEdge_dim, space_dim, bndT, index_t>& tpcc)
{
  return tpcc.size();
}
...
template <unsigned int hyEdge_dim,
          ...
          typename TPCC::boundaries bndT,
          typename index_t>
tpcc_elem_t<hyEdge_dim, space_dim> get_element(
  const tpcc_t<hyEdge_dim, space_dim, bndT, index_t>& tpcc,
  const index_t index)
{

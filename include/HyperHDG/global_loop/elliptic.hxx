...
class Elliptic
{
 ...
 public:
  ...
  LargeVecT trace_to_flux(const LargeVecT& x_vec, const param_time_t time = param_time_t())
  {
   ...
   ************************************************************************************************/
  template <typename hyNode_index_t = dof_index_t>
  sparse_mat<LargeVecT> trace_to_flux_mat(const param_time_t time = param_time_t())
  {
   ...
   ************************************************************************************************/
  template <typename hyNode_index_t = dof_index_t>
  LargeVecT residual_flux(const LargeVecT& x_vec, const param_time_t time = param_time_t())
  {
   ...
   ************************************************************************************************/
  template <typename hyNode_index_t = dof_index_t>
  std::vector<dof_value_t> errors(const LargeVecT& x_vec, const param_time_t time = param_time_t())
  {
   ...
   ************************************************************************************************/
  void plot_solution(const LargeVecT& lambda, const param_time_t time = param_time_t())
  {

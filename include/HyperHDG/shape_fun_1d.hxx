...
inline std::array<return_t, sizeInd> shape_fct_eval(const std::array<unsigned int, sizeInd>& index,
                                                    const input_t x_val)
{
 ...
 **************************************************************************************************/
template <typename return_t, typename shape_t, typename input_t, std::size_t sizeInd>
inline std::array<return_t, sizeInd> shape_der_eval(const std::array<unsigned int, sizeInd>& index,
                                                    const input_t x_val)
{
  std::array<return_t, sizeInd> result;
  for (unsigned int k = 0; k < sizeInd; ++k)

                          ...
                          const std::vector<dof_value_t>& right)
{
  ...
  for (dof_index_t i = 0; i < left.size(); ++i)
 ...
 **************************************************************************************************/
template <typename dof_index_t = unsigned int, typename dof_value_t = double>
void linear_combination(const dof_value_t leftFac,
                        const std::vector<dof_value_t>& leftV,
                        const dof_value_t rightFac,
                        const std::vector<dof_value_t>& rightV,
...
std::vector<dof_value_t> conjugate_gradient(const std::vector<dof_value_t>& b,
                                            ProblemT& problem,
                                            unsigned int n_iterations = 0,
                                            const dof_value_t tolerance = 1e-9)
{
  ...
  for (unsigned int k = 0; k < n_iterations; ++k)
  {
    ...
    linear_combination((dof_value_t)1., x, alpha, d, x);
    linear_combination((dof_value_t)1., r, -alpha, z, r);

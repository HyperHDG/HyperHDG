...
array<double, FuncQuad::compute_n_quad_points(max_quad_degree)> FuncQuad::quad_points()
{
...
template<unsigned int max_quad_degree>
array<double, FuncQuad::compute_n_quad_points(max_quad_degree)> FuncQuad::quad_weights()
{
  constexpr unsigned int n_points = FuncQuad::compute_n_quad_points(max_quad_degree);
  static_assert( 1 <= n_points && n_points <= 9 );
...
FuncQuad::shape_fcts_at_quad_points()
{
  constexpr unsigned int n_points = FuncQuad::compute_n_quad_points(max_quad_degree);
  static_assert( 1 <= max_poly_degree && max_poly_degree <= 5 );
  static_assert( 1 <= n_points && n_points <= 9);
  
  array<double, n_points> quad_points = FuncQuad::quad_points<max_quad_degree>();
...
template<unsigned int max_poly_degree, unsigned int max_quad_degree>
array< array<double, FuncQuad::compute_n_quad_points(max_quad_degree)> , max_poly_degree + 1 >
FuncQuad::shape_ders_at_quad_points()
{
  constexpr unsigned int n_points = FuncQuad::compute_n_quad_points(max_quad_degree);
  static_assert( 1 <= max_poly_degree && max_poly_degree <= 5 );
  static_assert( 1 <= n_points && n_points <= 9);
...
array< array<double, 2> , max_poly_degree + 1 > FuncQuad::shape_fcts_at_bdrs()
{
  static_assert( 1 <= max_poly_degree && max_poly_degree <= 5 );
...
template<unsigned int max_poly_degree>
array< array<double, 2> , max_poly_degree + 1 > FuncQuad::shape_ders_at_bdrs()
{
  static_assert( 1 <= max_poly_degree && max_poly_degree <= 5 );

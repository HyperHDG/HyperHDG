...
def diffusion_test(poly_degree, dimension, iteration, debug_mode=False):
  ...
  const.topology        = "CubicRefined<" + str(dimension) + "," + str(dimension) + "," + str(refinement) + ">"
  const.geometry        = "UnitCubeRefined<" + str(dimension) + "," + str(dimension) + "," + str(refinement) + ",double>"
  const.node_descriptor = "CubicRefined<" + str(dimension) + "," + str(dimension) + "," + str(refinement) + ">"

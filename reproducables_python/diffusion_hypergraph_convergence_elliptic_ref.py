...
def diffusion_test(poly_degree, dimension, iteration, debug_mode=False):
  ...
  const.topology        = "CubicRefined<" + str(dimension) + ",3," + str(refinement) + ">"
  const.geometry        = "UnitCubeRefined<" + str(dimension) + ",3," + str(refinement) + ",double>"
  const.node_descriptor = "CubicRefined<" + str(dimension) + ",3," + str(refinement) + ">"

...
from bilaplacian_convergence_eigenvalue_approx import eigenvalue_approx_MA
from bilaplacian_convergence_eigenvalue_shifted_inverse import eigenvalue_approx_SI
        ...
        for approx_type in range(2):
          if approx_type == 0:
            ...
            try:
              ...
              print("ERROR: ", error)
              errorNLSI = -1.
            f = open("output/bilaplacian_convergence_eigenvalue_combSI.txt", "a")
            ...
            try:
              ...
              print("ERROR: ", error)
              errorNLMA = -1.
            f = open("output/bilaplacian_convergence_eigenvalue_combMA.txt", "a")
            f.write("Polynomial degree = " + str(poly_degree) + ". Dimension = " + str(dimension) \

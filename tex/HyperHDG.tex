...
\begin{envarwarning}{State of implementation}
 ...
 The mass matrix representation given above does not work and I do not understand, why. The mass matrix, however does not seem to be far away. It does not exactly reproduce constants, but it does converge with optimal order for constants. The order becomes suboptimal, in the checked sin case.

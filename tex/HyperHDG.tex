...
\begin{table}[t]
 \begin{tabular}{cc|@{\,}lcc@{\,}lcc@{\,}lcc}
  ...
  & $i = 4$ && 2.51e-2 & 1.5 && 3.13e-2 & 2.0 && \textcolor{red}{4.86e-4} & 5  \\
  & $i = 5$ && 7.13e-3 & 1.8 && \textcolor{red}{2.12e-3} & 5 && 4.86e-4 & 5  \\
  \midrule
  \multirow{4}{*}{\rotatebox[origin=c]{90}{$\globDim = 2$, NL}}
  & $i = 2$ && 5.68e-1 & --- && 2.98e-3 & --- && 8.61e-6 & ---  \\
  & $i = 3$ && 5.80e-2 & 3.3 && 8.16e-5 & 5.2 && 6.18e-8 & 7.1  \\
  & $i = 4$ && 6.50e-3 & 3.2 && 2.24e-6 & 5.2 && \textcolor{red}{4.86e-4} & 5  \\
  & $i = 5$ && 7.71e-4 & 3.1 && \textcolor{red}{2.12e-3} & 5 && 4.86e-4 & 5  \\
  \bottomrule
 \end{tabular}\vspace{1ex}
...
\begin{table}[t]
 \begin{tabular}{cc|@{\,}lcc@{\,}lcc@{\,}lcc}
  ...
  & $i = 4$ && 5.69e-2 & 1.8 && \textcolor{red}{4.68e-9} & 7.1 && \textcolor{red}{4.86e-4} & 5  \\
  & $i = 5$ && 1.50e-2 & 1.9 && 2.12e-3 & 5 && 4.86e-4 & 5  \\
  \midrule
  \multirow{4}{*}{\rotatebox[origin=c]{90}{$\globDim = 2$, NL}}
  & $i = 2$ && 5.68e-1 & --- && 2.98e-3 & --- && 8.61e-6 & ---  \\
  & $i = 3$ && 5.80e-2 & 3.3 && 8.16e-5 & 5.2 && 6.18e-8 & 7.1  \\
  & $i = 4$ && 6.50e-3 & 3.2 && \textcolor{red}{2.39e-6} & 5.1 && \textcolor{red}{4.86e-4} & 5  \\
  & $i = 5$ && 7.71e-4 & 3.1 && 2.12e-3 & 5 && 4.86e-4 & 5  \\
  \bottomrule
 \end{tabular}\vspace{1ex}
...
\begin{table}[t]
 \begin{tabular}{cc|@{\,}lcc@{\,}lcc@{\,}lcc}
  ...
  & $i = 2$ && 1.37e-1 & --- && \textcolor{red}{5.52e-2} & --- && \textcolor{red}{7.53e-2} & ---  \\
  & $i = 3$ && 5.06e-2 & 1.4 && 4.22e-3 & 3.7 && 4.79e-3 & 4.0  \\
  & $i = 4$ && 1.43e-2 & 1.8 && 2.84e-4 & 3.9 && 3.01e-4 & 4.0  \\
  & $i = 5$ && \textcolor{red}{7.53e-3} & 3.1 && 1.83e-5 & 4.0 && 1.88e-5 & 4.0  \\
  \midrule
  \multirow{4}{*}{\rotatebox[origin=c]{90}{$\locDim = 1$, MA}}
  & $i = 2$ && 5.17e-1 & --- && 3.03e-1 & --- && 3.01e-1 & ---  \\
  & $i = 3$ && 1.27e-1 & 2.0 && 1.92e-2 & 4.0 && 1.91e-2 & 4.0  \\
  & $i = 4$ && \textcolor{red}{5.91e-2} & 3.0 && 1.20e-3 & 4.0 && 1.20e-3 & 4.0  \\
  & $i = 5$ && 7.32e-3 & 3.0 && 7.54e-5 & 4.0 && 7.53e-5 & 4.0  \\
  \midrule
  \multirow{4}{*}{\rotatebox[origin=c]{90}{$\locDim = 1$, NL}}
  & $i = 2$ && 2.84e-1 & --- && 2.94e-2 & --- && 8.50e-5 & ---  \\
  & $i = 3$ && 2.90e-2 & 3.3 && 8.06e-3 & 5.2 && 6.20e-7 & 7.1  \\
  & $i = 4$ && \textcolor{red}{3.25e-3} & 3.2 && 2.36e-5 & 5.1 && 4.83e-9 & 7.0  \\
  & $i = 5$ && \textcolor{red}{7.61e-3} & 3.1 && 7.18e-7 & 5.0 && 1.39e-8 & -2  \\
  \midrule
...
\begin{table}[t]
 \begin{tabular}{cc|@{\,}lcc@{\,}lcc@{\,}lcc}
  ...
  \midrule
  \multirow{4}{*}{\rotatebox[origin=c]{90}{$\globDim = 2$, SI}}
  & $i = 2$ && 2.16e1 & --- && \textcolor{red}{3.08e-2} & --- && \textcolor{red}{8.61e-6} & 7.3  \\
  & $i = 3$ && 2.26e0 & 3.3 && 7.73e-3 & 1.9 && 6.18e-8 & 7.1  \\
  & $i = 4$ && 2.55e-1 & 3.1 && 2.39e-6 & 5.1 && 4.86e-4 & 5  \\
  & $i = 5$ && \textcolor{red}{7.71e-5} & 3.1 && 2.12e-3 & 5 && 4.86e-4 & 5  \\
  \midrule
  \multirow{4}{*}{\rotatebox[origin=c]{90}{$\globDim = 2$, MA}}
  ...
  \midrule
  \multirow{4}{*}{\rotatebox[origin=c]{90}{$\globDim = 2$, NL}}
  & $i = 2$ && 2.21e1 & 3.0 && 2.98e-3 & 5.5 && 8.61e-6 & 7.3  \\
  & $i = 3$ && \textcolor{red}{2.28e0} & 3.3 && 8.16e-5 & 5.2 && 6.18e-8 & 7.1  \\
  & $i = 4$ && 2.56e-1 & 3.2 && 2.39e-6 & 5.1 && 4.86e-4 & 5  \\
  & $i = 5$ && \textcolor{red}{7.71e-5} & 3.1 && 2.12e-3 & 5 && 4.86e-4 & 5  \\
  \bottomrule
 \end{tabular}\vspace{1ex}
 \caption{Absolute errors (err) and estimated orders of convergence (eoc) of the smallest eigenvalue for a bilaplacian eigenvalue problem. Here, the shifted inverse (SI), mass approximation (MA) and nonlinear (NL) approaches are shown.}\label{TAB:bil_eigenvalue_conv}
\end{table}
% 
...
% 
To ensure that the elastic graph allows for an unique solution, we need to ensure that there is an unique way for it to be configured. To do so, we define the degree of static undeterminism $n$, for which $n < 0$ means that the truss is $-n$ times movable, $n = 0$ describes a statcially determined truss, and $n > 0$ indicates $n$ times over-dertemined trusses. The formula for $n$ is
% 
\begin{equation}
 n = a + s - \globDim k,
\end{equation}
% 
where $a$ is the amount of defined \ldots, $s$ is the number of edges / beams, and $k$ is the amount of nodes. \textcolor{red}{TODO!}

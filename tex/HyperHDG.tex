...
%
For the output files of our script, we create an empty directory \code{output} in case that it did not exist before.
%
\lstinputlisting[language=Python, firstline=11, lastline=11, firstnumber=11]{../examples/diffusion_elliptic.py}
%\lstinputlisting[language=Python]{../python/diffusion_elliptic.py}

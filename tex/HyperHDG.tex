...
\end{subequations}
% 
This local solver induces $\localU(\lambda,\eta)$, $\localQ(\lambda,\eta)$, $\localV(\lambda,\eta)$, and $\localR(\lambda,\eta)$. \arnote{TODO: Repeat the whole diffusion section here.}
% 
% ---------------------------------------------------------------------

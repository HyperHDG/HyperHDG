...
\begin{gather}\label{EQ:construct_unk_fu}
  ...
  \end{split}
\end{gather}\arerror{I believe this must be added! TODO: Check, why old version worked and implement this! Correct last plot and L2 error for parabolic cases!}
% 

...
The closing condition is replaced by the two closing conditions that for
% 
\begin{subequations}
\begin{align}
...
\end{subequations}
% 
This is bsically the formulation of the single face hybridizable scheme of \cite{CockburnDG2009}.\arnote{In my opinion.}
% 
% ---------------------------------------------------------------------

...
\begin{table}[t]
 \begin{tabular}{cc|@{\,}lcc@{\,}lcc@{\,}lcc}
  ...
  \midrule
  \multirow{6}{*}{\rotatebox[origin=c]{90}{$\globDim = 1$}}
  & $i = 0$ && \textcolor{red}{3.90e-2} & --- && 2.59e-3 & --- && 1.77e-4 & ---  \\
  & $i = 1$ && 5.18e-3 & 2.9 && 1.67e-4 & 4.0 && 5.64e-6 & 5.0  \\
  & $i = 2$ && 6.66e-4 & 3.0 && 1.06e-5 & 4.0 && 1.77e-7 & 5.0  \\
  & $i = 3$ && 8.44e-5 & 3.0 && 6.64e-7 & 4.0 && 5.53e-9 & 5.0  \\
  & $i = 4$ && 1.06e-5 & 3.0 && 4.15e-8 & 4.0 && 1.72e-10 & 5.0  \\
  & $i = 5$ && 1.33e-5 & 3.0 && 2.60e-9 & 4.0 && 5.40e-12 & 5.0  \\
  \midrule
  \multirow{6}{*}{\rotatebox[origin=c]{90}{$\globDim = 2$}}
  & $i = 0$ && 2.55e-2 & --- && 3.14e-3 & --- && 2.08e-4 & ---  \\
  & $i = 1$ && 4.83e-3 & 2.4 && 2.10e-4 & 3.9 && 6.98e-6 & 4.9  \\
  & $i = 2$ && 7.18e-4 & 2.8 && 1.37e-5 & 3.9 && 2.23e-7 & 5.0  \\
  & $i = 3$ && 1.01e-4 & 2.8 && 8.77e-7 & 4.0 && 7.08e-9 & 5.0  \\
  & $i = 4$ && 1.41e-5 & 2.8 && 5.59e-8 & 4.0 && 2.25e-10 & 5.0  \\
  & $i = 5$ && 1.98e-6 & 2.8 && 3.62e-9 & 3.9 && 7.27e-12 & 5.0  \\
  \bottomrule
 \end{tabular}\vspace{1ex}

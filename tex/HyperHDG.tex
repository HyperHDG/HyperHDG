...
% 
Simulating flow and transport phenomena on \emph{hypergraphs}, i.e. self-intersecting surfaces or lines (in three dimensions), is not new. Hybrid methods seem extremely promising for these applications. Thus, for example, \cite{HedinPE2019} uses the hybrid high order method to do flow simulations in discrete fracture networks.
% ---------------------------------------------------------------------

...
% 
\begin{itemize}
 \item one loop class for elliptic problems, cf. Section \ref{SEC:hdg_graph},
 \item one loop class for parabolic problems, cf. Section \ref{SEC:parabolic_diff},
 \item one loop class for the nonlinear eigenvalue approach as discussed in Section \ref{SEC:diff_eigen},
 \item one loop class for the shifted inverse eigenvalue approach which is described in Section \ref{SEC:diff_eigen},
...
\begin{table}[t]
 \begin{tabular}{cc|@{\,}lcc@{\,}lcc@{\,}lcc}
  ...
  & $i = 2$ && 2.69e-2 & --- && 4.82e-1 & --- && \textcolor{red}{2.69e-7} & ---  \\
  & $i = 3$ && 7.17e-2 & -1 && 1.23e-1 & 2.0 && 4.83e-10 & 9.1  \\
  & $i = 4$ && 2.51e-2 & 1.5 && \textcolor{red}{4.68e-9} & 7.1 && 4.86e-4 & 5  \\

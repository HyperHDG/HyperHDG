...
%
\lstinputlisting[language=Python, firstline=28, lastline=29, firstnumber=28]{../examples/diffusion_elliptic.py}
%
...
%
\lstinputlisting[language=Python, firstline=31, lastline=31, firstnumber=31]{../examples/diffusion_elliptic.py}
%
...
%
\lstinputlisting[language=Python, firstline=33, lastline=34, firstnumber=33]{../examples/diffusion_elliptic.py}
%
...
%
\lstinputlisting[language=Python, firstline=36, lastline=39, firstnumber=36]{../examples/diffusion_elliptic.py}
%
In the case that the analytical solution is known, we can also evaluate the error and print it using:
%
\lstinputlisting[language=Python, firstline=41, lastline=41, firstnumber=41]{../examples/diffusion_elliptic.py}
%
Additionally, we can plot the calculated solution after setting some plot options whose meaning can be found in the \code{doxygen}.
%
\lstinputlisting[language=Python, firstline=43, lastline=46, firstnumber=43]{../examples/diffusion_elliptic.py}
%
...
\begin{table}[t]
 \begin{tabular}{cc|@{\,}lcc@{\,}lcc@{\,}lcc}
  ...
  & $i = 2$ && 5.52e0 & --- && 2.94e-2 & --- && 8.50e-5 & ---  \\
  & $i = 3$ && 5.71e-1 & 3.3 && 8.06e-3 & 5.2 && 6.20e-7 & 7.1  \\
  & $i = 4$ && 6.42e-2 & 3.2 && 2.36e-5 & 5.1 && 4.71e-9 & 7.0  \\
  & $i = 5$ && 7.61e-3 & 3.1 && 7.07e-7 & 5.1 && 8.67e-9 & -.9  \\
  \midrule
  \multirow{4}{*}{\rotatebox[origin=c]{90}{$\locDim = 2$, SI}}
  & $i = 2$ && 2.16e1 & --- && 1.11e-1 & --- && \textcolor{red}{8.61e-6} & 7.3  \\
  & $i = 3$ && 2.26e0 & 3.3 && 1.20e-2 & 3.2 && 6.18e-8 & 7.1  \\
  ...
  \midrule
  \multirow{4}{*}{\rotatebox[origin=c]{90}{$\locDim = 2$, MA}}
  & $i = 2$ && 2.00e1 & --- && 8.01e-1 & --- && 8.61e-6 & 7.3  \\
  & $i = 3$ && 2.21e0 & 3.2 && 5.78e-2 & 3.8 && 6.18e-8 & 7.1  \\
  & $i = 4$ && 2.52e-1 & 3.1 && 3.83e-3 & 3.9 && 4.86e-4 & 5  \\
  & $i = 5$ && 3.01e-2 & 3.1 && 2.45e-4 & 4.0 && 4.86e-4 & 5  \\
  \midrule
  \multirow{4}{*}{\rotatebox[origin=c]{90}{$\locDim = 2$, NL}}
  & $i = 2$ && 2.21e1 & --- && 1.17e-1 & --- && 8.61e-6 & 7.3  \\
  & $i = 3$ && 2.28e0* & 3.3 && 3.22e-3 & 5.2 && 6.18e-8 & 7.1  \\
  & $i = 4$ && 2.56e-1 & 3.2 && 9.45e-5 & 5.1 && 4.86e-4 & 5  \\
  & $i = 5$ && ---    & --- && --- & --- && 4.86e-4 & 5  \\
  \bottomrule
 \end{tabular}\vspace{1ex}

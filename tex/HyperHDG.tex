...
\subsection{Numerical convergence tests}
% 
Implementing the parabolic and eigenvalue problems can then be done analogously to Section \ref{SEC:related_diffusion_problems} (for the according diffusion problems).
...
\begin{table}
 \begin{tabular}{cc|@{\,}lcc@{\,}lcc@{\,}lcc}
  ...
  \midrule
  \multirow{6}{*}{\rotatebox[origin=c]{90}{$\globDim = 1$}}
  & $i = 0$ && \textcolor{red}{3.09e-1} & --- && 6.23e-1 & --- && 2.78e-3 & ---  \\
  ...
  & $i = 5$ && 6.13e-5 & 2.3 && 3.59e-7 & 3.4 && 1.59e-9 & 0.3  \\
  \bottomrule
 \end{tabular}\vspace{1ex}

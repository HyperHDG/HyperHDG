...
\begin{table}[t]
 \begin{tabular}{c|@{\,}lcc@{\,}lcc@{\,}lcc}
  ...
  \multicolumn{1}{c|@{\,}}{mesh}    && err & eoc && err & eoc && err & eoc   \\
  \midrule
  $i = 0$ && 2.30e-2 & --- && 2.44e-1 & --- && 2.38e-2 & ---  \\
  $i = 1$ && 8.66e-2 & 1.4 && 7.50e-2 & 1.7 && 3.20e-3 & 2.9  \\
  $i = 2$ && 3.60e-2 & 1.3 && 2.42e-2 & 1.6 && 4.16e-4 & 2.9  \\
  $i = 3$ && 1.62e-2 & 1.2 && 8.11e-3 & 1.6 && 5.31e-5 & 3.0  \\
  $i = 4$ && 7.66e-3 & 1.1 && 2.78e-5 & 1.5 && 6.71e-6 & 3.0  \\
  $i = 5$ && 3.72e-5 & 1.0 && \textcolor{red}{8.39e-6} & 2.5 && 8.43e-7 & 3.0  \\
  \bottomrule
 \end{tabular}\vspace{1ex}

...
% 
% ---------------------------------------------------------------------
\section{Different local solvers for the diffusion problem}\label{SEC:other_solvers}
% ---------------------------------------------------------------------
% 
...
\end{equation}
% 
The flux unknown can be obtained in an additional post-processing step via $\vec Q = - d \nabla U$. Nevertheless the most significant difference between the IP-H and the LDG-H methods consists in the fact that the local problems for IP-H are significantly smaller.\arnote{TODO: Check, whether matrix is still SPD!}

A comparison of the total errors can be conducted evaluating Tables ??? -- ??? and comparing them to their LDG-H analogues.\arerror{TODO: Implement method and compare!}
% 
% ---------------------------------------------------------------------

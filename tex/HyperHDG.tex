...
\begin{table}
 \begin{tabular}{cc|@{\,}lcc@{\,}lcc@{\,}lcc}
  ...
  & $i = 4$ && 7.08e-5 & 2.1 && 4.49e-7 & 3.1 && 4.86e-4 & 5  \\
  & $i = 5$ && 1.73e-5 & 2.0 && \textcolor{red}{2.12e-3} & 5 && 4.86e-4 & 5  \\
  \bottomrule
...
The convergence of the eigenvalue with the smallest magnitude is depicted in Table \ref{TAB:eigs_conv}.
% 
\begin{table}
 \begin{tabular}{cc|@{\,}lcc@{\,}lcc@{\,}lcc}
  \toprule
  ...
  \midrule
  \multirow{6}{*}{\rotatebox[origin=c]{90}{$\globDim = 1$}}
  & $i = 2$ && 5.17e-1 & --- && \textcolor{red}{8.20e-3} & --- && \textcolor{red}{8.04e-4} & ---  \\
  & $i = 3$ && 1.27e-1 & -1 && 5.57e-4 & 3.8 && 2.63e-5 & 4.9  \\
  & $i = 4$ && 3.17e-2 & -1 && 4.25e-5 & 3.7 && 9.15e-7 & 4.8  \\
  & $i = 5$ && 7.93e-3 & -1 && 4.03e-6 & 3.3 && 3.76e-8 & 4.6  \\
  & $i = 6$ && 1.98e-3 & 2.0 && 4.54e-7 & 3.1 && 1.92e-9 & 4.2  \\
  & $i = 7$ && \textcolor{red}{2.95e-5} & 2.0 && 5.51e-8 & 3.0 && 1.12e-10& 4.0  \\
  \bottomrule
 \end{tabular}\vspace{1ex}

...
\begin{table}[t]
 \begin{tabular}{cc|@{\,}lcc@{\,}lcc@{\,}lcc}
  ...
  & $i = 5$ && 7.13e-3 & 1.8 && 7.88e-3 & 2.0 && 4.86e-4 & 5  \\
  \midrule
  ...
  & $i = 5$ && 7.71e-4 & 3.1 && 7.02e-8 & 5.0 && 4.86e-4 & 5  \\
  \bottomrule
 \end{tabular}\vspace{1ex}
...
\begin{table}[t]
 \begin{tabular}{cc|@{\,}lcc@{\,}lcc@{\,}lcc}
  ...
  & $i = 4$ && 5.69e-2 & 1.8 && 6.27e-2 & 2.0 && \textcolor{red}{4.86e-4} & 5  \\
  & $i = 5$ && 1.50e-2 & 1.9 && 1.57e-2 & 2.0 && 4.86e-4 & 5  \\
  \midrule
  \multirow{4}{*}{\rotatebox[origin=c]{90}{$\globDim = 2$, NL}}
  & $i = 2$ && 5.68e-1 & --- && 2.98e-3 & --- && 8.61e-6 & ---  \\
  & $i = 3$ && 5.80e-2 & 3.3 && 8.16e-5 & 5.2 && 6.18e-8 & 7.1  \\
  & $i = 4$ && 6.50e-3 & 3.2 && 2.39e-6 & 5.1 && \textcolor{red}{4.86e-4} & 5  \\
  & $i = 5$ && 7.71e-4 & 3.1 && 6.27e-8 & 5.3 && 4.86e-4 & 5  \\
  \bottomrule
 \end{tabular}\vspace{1ex}

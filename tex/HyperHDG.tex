...
\begin{table}[t]
 \begin{tabular}{cc|@{\,}lcc@{\,}lcc@{\,}lcc}
  ...
  & $i = 1$ && 4.44e-0 & --- && \textcolor{red}{4.36e-4} & --- && \textcolor{red}{2.15e-5} & ---  \\
  & $i = 2$ && 5.68e-1 & 3.0 && 3.88e-5 & 3.4 && 8.41e-7 & 4.6  \\
  & $i = 3$ && 5.80e-2 & 3.3 && 3.90e-6 & 3.3 && 4.86e-4 & 5  \\
  & $i = 4$ && 6.50e-3 & 3.2 && 2.12e-3 & 5 && 4.86e-4 & 5  \\
...
\begin{table}
 \begin{tabular}{cc|@{\,}lcc@{\,}lcc@{\,}lcc}
  ...
  \midrule
  \multirow{6}{*}{\rotatebox[origin=c]{90}{$\globDim = 2$}}
  & $i = 0$ && 1.22e-1 & --- && 1.80e-1 & --- && \textcolor{red}{1.80e-3} & ---  \\
  & $i = 1$ && 1.57e-2 & -.4 && 2.31e-2 & 3.0 && 1.18e-3 & 0.6  \\
  & $i = 2$ && 5.11e-2 & 1.6 && 3.34e-3 & 2.8 && 3.97e-5 & 4.8  \\
  & $i = 3$ && 1.41e-2 & 1.9 && 4.44e-4 & 2.9 && 1.31e-6 & 4.9  \\
  & $i = 4$ && 3.70e-3 & 1.9 && 5.73e-5 & 3.0 && 4.47e-8 & 4.8  \\
  & $i = 5$ && 9.50e-4 & 2.0 && 7.32e-6 & 3.0 && 1.59e-9 & 0.3  \\
  \bottomrule
 \end{tabular}\vspace{1ex}

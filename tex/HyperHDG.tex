...
\end{subequations}
% 
This is bsically the formulation of the single face hybridizable scheme of \cite{CockburnDG2009}.
% 
\begin{envarwarning}{I think!}
 ...
 Moreover, the following mass matrix seems to have a bug!
\end{envarwarning}
% 
...
\end{align}
% 
which represents the analogon to the right-hand side $b$. \arnote{Mass matrix is not really working well.}
% 
% ---------------------------------------------------------------------

...
\begin{table}[t]
 \begin{tabular}{c|@{\,}lcc@{\,}lcc@{\,}lcc}
  ...
  $i = 4$ && 7.66e-3 & 1.1 && 2.78e-5 & 1.5 && 6.71e-6 & 3.0  \\
  $i = 5$ && 3.72e-5 & 1.0 && 9.71e-6 & 1.5 && 8.43e-7 & 3.0  \\
  \bottomrule
 \end{tabular}\vspace{1ex}

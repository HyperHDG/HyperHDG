...
\begin{table}[t]
 \begin{tabular}{cc|@{\,}lcc@{\,}lcc@{\,}lcc}
  ...
  & $i = 3$ && 4.56e-4 & 5.4 && 6.38e-7 & 7.2 && \textcolor{red}{6.18e-8} & 7.1  \\
  & $i = 4$ && 1.27e-5 & 5.2 && \textcolor{red}{2.39e-6} & 5.1 && 4.86e-4 & 5  \\
...
\begin{table}[t]
 \begin{tabular}{cc|@{\,}lcc@{\,}lcc@{\,}lcc}
  ...
  \midrule
  \multirow{4}{*}{\rotatebox[origin=c]{90}{$\globDim = 2$, SI}}
  & $i = 2$ && \textcolor{red}{5.68e-1} & 3.0 && \textcolor{red}{2.98e-3} & 5.5 && \textcolor{red}{8.61e-6} & 7.3  \\
  & $i = 3$ && 5.80e-2 & 3.3 && 8.16e-5 & 5.2 && 6.18e-8 & 7.1  \\
  & $i = 4$ && 6.50e-3 & 3.2 && 2.39e-6 & 5.1 && 4.86e-4 & 5  \\
  & $i = 5$ && 7.71e-5 & 3.1 && 2.12e-3 & 5 && 4.86e-4 & 5  \\
  \midrule

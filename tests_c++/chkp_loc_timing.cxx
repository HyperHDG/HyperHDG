...
int main()
{
  ...
  auto he = *it;
  {
    ...
    std::cout << "Local residual took "
              << std::chrono::duration_cast<std::chrono::milliseconds>(end_lr - start_lr).count() /
                   100.
              << "ms\n";
    ...
    std::cout << "Jacobian took "
              << std::chrono::duration_cast<std::chrono::milliseconds>(end_j - start_j).count() /
                   100.
              << "ms\n";
    ...
    std::cout << "Newton took "
              << std::chrono::duration_cast<std::chrono::milliseconds>(end_n - start_n).count() /
                   100.
              << "ms for " << newton_iter << " iterations\n";
    ...
    std::cout << "Coupling took "
              << std::chrono::duration_cast<std::chrono::milliseconds>(end_c - start_c).count() /
                   100.
              << "ms\n";
    ...
    std::cout << "Residual flux took "
              << std::chrono::duration_cast<std::chrono::milliseconds>(end_rf - start_rf).count() /
                   100.
              << "ms\n";

...
Space_Dim     = 1;  # Dimension of space indicating amount of coordinates of points.
HyperEdge_Dim = 1;  # Dimension of hyperedge (must be uniform).

N_Points      = 2;  # Number of vertices that are contained in the hypergraph.
N_HyperNodes  = 2;  # Number of hypernodes that are contained in the hypergraph.

# File containing geometric and topological information for of hypergraph being a square.
...
N_Points      = 4;  # Number of vertices that are contained in the hypergraph.
N_HyperNodes  = 4;  # Number of hypernodes that are contained in the hypergraph.

...
CUT=.4
PTS=$DOMAIN.pts
MAKEGEO=submodules/fiber_network.git/fiber_network/make_geo.py
...
python $MAKEGEO -i $INPUT --clamp-xy $CUT -o $DOMAIN \
       --points $PTS
python experiments/ne18-08-dd-ref.py --domain $DOMAIN --points $PTS --subdomains 8

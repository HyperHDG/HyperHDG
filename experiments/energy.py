...
def write_tikz(prefix, t, grouped, log=False):
    ...
    series = [("strain", "strain energy"), ("kinetic", "kinetic energy"),
    ...
    if log:
        L.append("  ymode=log,")
    L.extend([
        # south east: only the ~0 hybrid line runs behind the legend box there
    ...
    L.append(f"\\addplot[black, thick] table[x=t, y=total, col sep=comma] "
             f"{{\\plotdatadir {csv_path.name}}};")
    L.append("\\addlegendentry{total energy}")

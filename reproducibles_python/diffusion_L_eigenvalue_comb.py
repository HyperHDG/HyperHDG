...
from diffusion_L_eigenvalue_approx import eigenvalue_approx_MA
from diffusion_L_eigenvalue_shifted_inverse import eigenvalue_approx_SI
from diffusion_L_eigenvalue_newt import eigenvalue_newt
        ...
        for approx_type in range(2):
          if approx_type == 0:
            ...
            try:
              ...
              print("ERROR: ", error)
              errorNLSI = -1.
            f = open("output/diffusion_L_eigenvalue_combSI.txt", "a")
            ...
            try:
              ...
              print("ERROR: ", error)
              errorNLMA = -1.
            f = open("output/diffusion_L_eigenvalue_combMA.txt", "a")
            f.write("Polynomial degree = " + str(poly_degree) + ". Dimension = " + str(dimension) \

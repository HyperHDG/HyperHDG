...
# --------------------------------------------------------------------------------------------------
def diffusion_test(poly_degree, dimension, iteration, vectorSolution_in = 0, debug_mode=False):
  ...
  HDG_wrapper.plot_option("fileName",
                          "diff_solution_true" + str(dimension) + "-" + str(poly_degree) + "-" + str(iteration))
  ...
  ref_solution = HDG_wrapper.refine_solution(vectorSolution)
  print("\nRefined solution:")
  print(ref_solution)
  print("\n")

  HDG_wrapper.refine(2)
  HDG_wrapper.plot_option("fileName", "diff_refined_estimate" + str(dimension) + "-" + str(poly_degree) + "-" + str(iteration))
  HDG_wrapper.plot_option("printFileNumber", "false")
  HDG_wrapper.plot_option("scale", "0.95")
  HDG_wrapper.plot_solution(ref_solution)
  print("")
  ...
  HDG_wrapper.plot_option("fileName",
                          "diff_solution_ref_true" + str(dimension) + "-" + str(poly_degree) + "-" + str(iteration))
  HDG_wrapper.plot_option("printFileNumber", "false")
  HDG_wrapper.plot_option("scale", "0.95")
  HDG_wrapper.plot_solution(vectorSolution)

  print("\n\nRefined vector solution:")
  print(vectorSolution)
...
def main(debug_mode):
  for poly_degree in [0, 1]:
    ...
    for dimension in [2]:
      ...
      for iteration in [0]:
        try:
          diffusion_test(poly_degree, dimension, iteration, 0, debug_mode)

 ...
 * 
 * This class implements a point in a @f$d@f$-dimensional space, where the @f$d@f$ is given by the template
 * parameter @c space_dim.
 * 
...
class Point
{
  ...
  public:
	 ...
	 * 
	 * @param	coord_entry	An @c unsigned @c int referring to the coordinate that is to be returnes.
	 * @retval	coordinate	A reference to a @c point_coord_type describing the coord_entry'th coordinate.
	 **********************************************************************************************************/
	 ...
	 * 
	 * This function compares the point to another point and returns true if and only if both points have
	 * exactly (that is not only with respect to some rounding errors) the same coordinates.
	 * 
     ...
     * @brief	Find out whether two points have (exactly) the same coordinates.
	 * 
	 * This function compares the point to another point and returns false if and only if both points have
	 * exactly (that is not only with respect to some rounding errors) the same coordinates.
	 * 
	 * @param	other_point	Another @c Point<space_dim> that is to be dicriminate from.
	 ...
	 * 
	 * This function compares the point to another point and returns true if and only if the lowest ranked
	 * coordinate (according to the coordinate index) where the both points are not equal of the given point is
	 * smaller than that of the other point. It is false, if both points are equal.
	 * 
	 * @param	other_point	Another @c Point<space_dim> that is to be dicriminate from.
	 * @retval	isEqual		A @c boolean which is true if the left point is strictly smaller than the right one.
	 **********************************************************************************************************/
    bool operator<(const Point<space_dim>& other_point) const;
};
/*
